...
import './css/compwarn.css';
import { reduceHooks } from 'react-table';

function Compexamwarn(){
  let history = useHistory();
    ...
    const logout = ()=>{
      ...
      const compexid = JSON.parse(localStorage.getItem('compexamid'));

      function accept(){
        history.push("/student/attcompex");
      }

      function goback(){
        localStorage.removeItem('compexamid');
